...
$sql2="SELECT * FROM stockin WHERE catid='$catid' AND subcat='$subcat' AND user='$user' AND DATE(dt) BETWEEN '$from' AND '$to'";
      ...
      if(mysqli_num_rows($result2)==0)
        { if (mysqli_num_rows($result1)>0){
          ...
          while( $row3=mysqli_fetch_array($result3)){
           $sql4="SELECT * FROM stockin WHERE catid='$catid' AND user='$user' AND subcat='$row3[0]' AND DATE(dt) BETWEEN '$from' AND '$to'";
